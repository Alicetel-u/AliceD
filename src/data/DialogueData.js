...
export const DialogueData = {
    ...
    'STAGE1_OPENING': [
        { "name": "アリス", "text": "いい天気！今日こそ大好きなあのこを見つけるよっ！", "side": "left", "image": "alicetalk1" },
        { "name": "アリス", "text": "邪魔する敵はふっ飛ばしちゃうからね！", "side": "left", "image": "alicetalk1" }
    ],
    'STAGE1_MID': [
    ...
    'STAGE1_BOSS_START': [
        { "name": "月の守護者：モチツキ・タイタン", "text": "我は月の守護者、モチツキ・タイタン！", "side": "right", "image": "" },
        { "name": "月の守護者：モチツキ・タイタン", "text": "この先の聖地へは通さん！餅にしてやる！", "side": "right", "image": "", "keepLeft": true },
        { "name": "アリス", "text": "お餅も好きだけど…今はニンジンが食べたいの！どいてよ！", "side": "left", "image": "alicetalk1", "keepRight": true }
    ],
    'STAGE1_BARRIER_BREAK': [
        { "name": "モチツキ・タイタン", "text": "ぐぬぬ…我が結界が…！", "side": "right", "image": "" },
        { "name": "アリス", "text": "チャンス！今なら<span style='color:#f1c40f;'>ジャンプ攻撃</span>が通じるよっ！", "side": "left", "image": "alicetalk1" }
    ],
    'STAGE1_BOSS_DEFEAT': [
        { "name": "月の守護者：モチツキ・タイタン", "text": "み、見事だ…まさかウサギに負けるとは…。", "side": "right", "image": "" },
        { "name": "アリス", "text": "やったー！私の勝ちね！", "side": "left", "image": "alicetalk1", "keepRight": true },
        { "name": "アリス", "text": "さあ、新しい場所へ！カノンちゃんを探しに行こう！", "side": "left", "image": "alicetalk1" }
    ],
    ...
    'STAGE2_BOSS_START': [
        { name: "深淵の幻影：シスター？？？", text: "迷える子ウサギよ……。その小さな体で、いつまで『希望』なんて重い荷物を背負い続けるのですか？", side: "right", image: "" },
        { name: "アリス", text: "なんてこと言うの！ あなたみたいな悪いシスターさんは、私が成敗するんだから！", side: "left", image: "alicetalk1", keepRight: true },
        { name: "深淵の幻影：シスター？？？", text: "成敗……？ ふふ、違いますよ。私はただ、この辛い物語の『幕』を下ろしてあげたいだけなのです。", side: "right", image: "", keepLeft: true }
    ],
    'STAGE2_BARRIER_BREAK': [
        { "name": "深淵の幻影：シスター？？？", "text": "ああ……なぜ拒むのです？ 諦めれば、楽になれるというのに……！", "side": "right", "image": "" },
        { "name": "アリス", "text": "えっ……その顔……ウソでしょ！？", "side": "left", "image": "alicetalk1" },
        { "name": "アリス", "text": "カノンちゃん！？ どうして！？なんで……！", "side": "left", "image": "alicetalk1" }
    ],
    'STAGE2_BOSS_DEFEAT': [
        { name: "カノン？", text: "……痛いよ、アリス……。もう、何もかも疲れちゃったよ……。", side: "right", image: "" },
        { name: "アリス", text: "待って！ 説明してよカノンちゃん！", side: "left", image: "alicetalk1", keepRight: true },
        { name: "カノン？", text: "（悲しげな祈りの言葉を残し、彼女は霧のように消えた……）", side: "right", image: "" },
        { name: "アリス", text: "なんで……どうして……。", side: "left", image: "alicetalk1" }
    ],

    // --- STAGE 3 (Toy Box) ---
    'STAGE3_OPENING': [
        { "name": "アリス", "text": "おもちゃがいっぱい……。ねえ、私の体、少し糸がほつれてない？", "side": "left", "image": "alicetalk1" },
        { "name": "アリス", "text": "カノンちゃんに直してもらわなきゃ。……あれ、糸って何？", "side": "left", "image": "alicetalk1" }
    ],
    'STAGE3_MID': [
    ...
    'STAGE3_BOSS_START': [
        { name: "キング・レゴロ", text: "我は玩具の王なり。古びたウサギよ、汝の役目は終わったのだ。", side: "right", image: "" },
        { name: "キング・レゴロ", text: "綿は痩せ、色は褪せた。主（あるじ）も居らぬ今、土に還るがよい！", side: "right", image: "", keepLeft: true },
        { name: "アリス", text: "違う！ 私の役目は終わってない！ カノンちゃんが待ってるの！", side: "left", image: "alicetalk1" }
    ],
    'STAGE3_BARRIER_BREAK': [
        { "name": "キング・レゴロ", "text": "認めよ！ 汝の時間はもう残されていないのだ！", "side": "right", "image": "" },
        { "name": "アリス", "text": "分かってるよ！ 私が一番分かってる！ だから……！", "side": "left", "image": "alicetalk1" },
        { "name": "アリス", "text": "このボロボロの体でも、最後に一つだけできることがあるはず！！", "side": "left", "image": "alicetalk1" }
    ],
    'STAGE3_BOSS_DEFEAT': [
        { name: "キング・レゴロ", text: "見事なり……。その灯火、主のために使い果たすが良い……。", side: "right", image: "" },
    ...
    'STAGE5_BOSS_START': [
        { name: "デウス・エクス", text: "よく来たな、地上のうさぎよ。", side: "right", image: "" },
        ...
        { name: "デウス・エクス", text: "アレは私が連れて行くと決めた、初めから決めていたのだ。", side: "right", image: "", keepLeft: true },
        { name: "デウス・エクス", text: "彼女の魂の輝きを刈り取る、それが理（ことわり）なのだよ。", side: "right", image: "", keepLeft: true },
    ...
    'STAGE5_BARRIER_BREAK': [
        { name: "デウス・エクス", text: "素晴らしい輝きだ。だが、死神の鎌からは逃れられん！", side: "right", image: "" },
    ...
    'STAGE5_BOSS_DEFEAT': [
        ...
        { name: "カノンの声", text: "アリス……？", side: "right", image: "" },
    ...
    'STAGE1_BOSS_START_KANON': [
        { name: "不要データ排除：モチツキ・タイタン", text: "ピー……ガガ……未確認オブジェクト……排除……。", side: "right", image: "" },
        { name: "カノン", text: "わっ、びっくりした！ なにこのロボット、ちょっと通りたいだけなんですけど！", side: "left", image: "kanontalk1", keepRight: true },
        { name: "不要データ排除：モチツキ・タイタン", text: "バグ駆除モード起動。ターゲットロック。", side: "right", image: "", keepLeft: true }
    ],
    'STAGE1_BARRIER_BREAK_KANON': [
        { name: "不要データ排除：モチツキ・タイタン", text: "装・甲・破・損……警告……。", side: "right", image: "" },
        { name: "カノン", text: "もう、しつこいなぁ！ 私、急いでるんだから邪魔しないでよ！", side: "left", image: "kanontalk1" }
    ],
    'STAGE1_BOSS_DEFEAT_KANON': [
        { name: "不要データ排除：モチツキ・タイタン", text: "システム……ダウン……。", side: "right", image: "" },
    ...
    'STAGE2_BOSS_START_KANON': [
        { name: "深淵の幻影：シスター？？？", text: "おかわいそうな方……迷い続けているのですね。", side: "right", image: "" },
        { name: "カノン", text: "誰？ 私は迷ってないよ、友達を探してるだけだもん。", side: "left", image: "kanontalk1", keepRight: true },
        { name: "深淵の幻影：シスター？？？", text: "いいえ、あなたは探しているのではなく、逃げているのです。「終わり」から。", side: "right", image: "", keepLeft: true }
    ],
    'STAGE2_BARRIER_BREAK_KANON': [
        { name: "深淵の幻影：シスター？？？", text: "ああ……拒絶するのですか？ こんなにも穏やかな「諦め」を。", side: "right", image: "" },
        { name: "カノン", text: "諦めるなんて言葉、大っ嫌い！ 私は絶対に見つけるまでは止まらない！", side: "left", image: "kanontalk1" }
    ],
    'STAGE2_BOSS_DEFEAT_KANON': [
        { name: "深淵の幻影：シスター？？？", text: "そうですか……では、進みなさい。その先に待つのが絶望だとしても。", side: "right", image: "" },
    ...
    'STAGE3_BOSS_START_KANON': [
        { name: "玩具の王：キング・レゴロ", text: "帰りたくなかろう？ 向こう側には「痛み」と「終わり」しかないのだから。", side: "right", image: "" },
        { name: "カノン", text: "……やっぱり。あなたは私をここに閉じ込めるための、優しい牢獄の看守なのね。", side: "left", image: "kanontalk1", keepRight: true },
        { name: "玩具の王：キング・レゴロ", text: "賢しい子よ。此処で永遠に遊んでいれば、苦しみなど知らずに済むものを！", side: "right", image: "", keepLeft: true }
    ],
    'STAGE3_BARRIER_BREAK_KANON': [
        { name: "玩具の王：キング・レゴロ", text: "やめろ！ この世界を壊せば、お前は無慈悲な現実に晒されるぞ！！", side: "right", image: "" },
        { name: "カノン", text: "それでもいい！ 偽物の幸せの中で笑ってるなんて、そんなの、私が一番許せない！！", side: "left", image: "kanontalk1" }
    ],
    'STAGE3_BOSS_DEFEAT_KANON': [
        { name: "玩具の王：キング・レゴロ", text: "……愚かな。だが、その愚直さこそが「生」なのかもしれぬな……。", side: "right", image: "" },
        { name: "カノン", text: "ありがとう、王様。夢を見せてくれて。……でも、もう起きなきゃ。", side: "left", image: "kanontalk1", keepRight: true },
        { name: "カノン", text: "アリスが待ってる、私を呼んでる気がするの。", side: "left", image: "kanontalk1" }
    ],
    ...
    'STAGE4_BOSS_START_KANON': [
        { name: "絶望に至る病：KANON", text: "あ……あぁ……イタイ……助ケテ……誰カ……。", side: "right", image: "" },
        { name: "カノン", text: "！！ ……嘘、あれは私？ あんな姿で、苦しんで……。", side: "left", image: "kanontalk1", keepRight: true },
        { name: "絶望に至る病：KANON", text: "オ前モ……コウナルンダ……。逃ゲ場ナンテ……ドコニモナイ……ッ！！", side: "right", image: "", keepLeft: true }
    ],
    'STAGE4_BARRIER_BREAK_KANON': [
        { name: "絶望に至る病：KANON", text: "嫌ダ……死ニタクナイ……ッ！！ 体ガ……崩レテイク……ッ！！", side: "right", image: "" },
        { name: "カノン", text: "泣かないで……！ 私だって怖い、怖いよ！ でもここで負けたら, アリスに会えないんだ！", side: "left", image: "kanontalk1" }
    ],
    'STAGE4_BOSS_DEFEAT_KANON': [
        { name: "絶望に至る病：KANON", text: "……アリス……会イタカッタ……。", side: "right", image: "" },
    ...
    'STAGE5_BOSS_START_KANON': [
        { name: "デウス・エクス", text: "Time out. 対象コード：KANON。全機能停止プロセスへ移行。", side: "right", image: "" },
        { name: "カノン", text: "！！ あそこに倒れてるの……アリス！？ そんな……動いてよアリス！！", side: "left", image: "kanontalk1", keepRight: true },
        { name: "デウス・エクス", text: "無駄だ。彼女のデータは既にパージされた。次は貴様の番だ。", side: "right", image: "", keepLeft: true }
    ],
    'STAGE5_BARRIER_BREAK_KANON': [
        { name: "デウス・エクス", text: "Fatal Error. 異常な感情係数を検知。強制排除を実行する！", side: "right", image: "" },
    ...
    'STAGE5_BOSS_DEFEAT_KANON': [
        { name: "デウス・エクス", text: "……Process Terminated. ……Have a nice dream.", side: "right", image: "" },
        ...
        { name: "システム", text: "（二つの魂は寄り添い、温かな光の中へと溶けていった……）", side: "center", image: "" }
    ]
};
